 ...
 * 基于320亿Token中文金融语料训练，在金融情感分析任务上F1-score达0.895
 */
@Slf4j
@RestController
@RequestMapping("/api/models/sentiment")
@RequiredArgsConstructor
@Tag(name = "情感分析模型", description = "情感分析模型训练、推理相关接口，支持FinBERT2金融情感分析模型，基于320亿Token中文金融语料训练，在金融情感分析任务上F1-score达0.895")
public class SentimentController {
     ...
     */
    @PostMapping("/train")
    @Operation(summary = "训练情感分析模型", description = "使用新闻数据训练情感分析模型，支持FinBERT2金融领域微调")
    ...
    @Operation(summary = "获取训练状态", description = "查询情感分析模型训练进度，适用于FinBERT2等模型训练")
     ...
     */
    @PostMapping("/analyze")
    @Operation(summary = "情感分析", description = "分析给定文本的情感倾向，使用FinBERT2金融情感模型")
    ...
    @Operation(summary = "批量情感分析", description = "批量分析多条文本的情感倾向，针对FinBERT2优化")
     ...
     */
    @GetMapping("/health")
    @Operation(summary = "健康检查", description = "检查情感分析服务状态，确认FinBERT2模型加载成功")
    public ResponseEntity<Map<String, Object>> health() {
        Map<String, Object> response = new HashMap<>();
        response.put("status", "UP");
        response.put("service", "Sentiment Analysis Service (FinBERT2 Enhanced)");
     ...
     */
    @PostMapping("/reload")
    @Operation(summary = "重新加载模型", description = "重新加载情感分析模型，支持FinBERT2等")
    public ResponseEntity<Map<String, Object>> reloadModel() {
        try {
            ...
            Map<String, Object> response = new HashMap<>();
            response.put("success", true);
            response.put("message", "FinBERT2模型重新加载成功");
            response.put("modelLoaded", sentimentInference.isLoaded());
    ...
    @Operation(summary = "下载预训练模型", description = "从 HuggingFace 下载FinBERT2等预训练模型")
    public ResponseEntity<Map<String, Object>> downloadModel() {
        try {
            ...
            Map<String, Object> response = new HashMap<>();
            response.put("success", true);
            response.put("message", "FinBERT2预训练模型下载成功");
