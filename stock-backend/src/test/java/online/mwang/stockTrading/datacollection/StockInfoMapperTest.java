...
import online.mwang.stockTrading.app.StockTradingApplication;
import online.mwang.stockTrading.entity.StockInfo;
import online.mwang.stockTrading.repository.StockInfoRepository;
...
class StockInfoMapperTest {
    ...
    class InsertTests {
        ...
        void testInsert_Success() {
            ...
            // 验证可以查询到
            StockInfo saved = stockInfoRepository.findByCode(stock.getCode());
    ...
    class GetByCodeTests {
        ...
        void testGetByCode_Exists() {
            ...
            // When: 根据代码查询
            StockInfo result = stockInfoRepository.findByCode(testStock.getCode());
        ...
        void testGetByCode_NotExists() {
            ...
            // When: 查询不存在的股票
            StockInfo result = stockInfoRepository.findByCode(nonExistCode);
    ...
    class UpdateTests {
        ...
        void testUpdate_Success() {
            ...
            // When: 调用更新方法
            StockInfo updated = stockInfoRepository.update(testStock);

            // Then: 验证更新成功
            assertNotNull(updated, "应返回更新后的对象");

            // 验证字段值已改变
            StockInfo result = stockInfoRepository.findByCode(testStock.getCode());
            assertEquals("更新后的名称", result.getName(), "名称应已更新");
            assertEquals("更新后的行业", result.getIndustry(), "行业应已更新");
        }
    }
    ...
    class DeleteTests {
        ...
        void testDelete_Success() {
            ...
            // When: 调用删除方法
            StockInfo stock = stockInfoRepository.findByCode(code);
            stockInfoRepository.delete(stock);

            // Then: 验证删除成功
            StockInfo deleted = stockInfoRepository.findByCode(code);
    ...
    class BatchInsertTests {
        ...
        void testBatchInsert_Performance() {
            ...
            for (StockInfo stock : stockList) {
                try {
                    stockInfoRepository.save(stock);
                    if (stock.getId() != null) successCount++;
                } catch (Exception e) {
                    // 忽略重复键错误
                }
            }
            ...
            // Then: 验证结果
            assertTrue(successCount > 0, "应有数据插入成功");
    ...
    class GetNameByCodeTests {
        ...
        void testGetNameByCode_Success() {
            ...
            // When: 根据代码获取名称
            String name = stockInfoRepository.findNameByCode(testStock.getCode());
        ...
        void testGetNameByCode_NotExists() {
            // When: 查询不存在的代码
            String name = stockInfoRepository.findNameByCode("NOTEXIST");
